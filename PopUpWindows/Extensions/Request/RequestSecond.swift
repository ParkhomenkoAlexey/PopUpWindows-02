...
class RequestFinishAlert: UIView {
...
extension RequestFinishAlert {
    func setupElements() {
        ...
        specialtyLabel.text = "Thank you for purchasing. Your order will be shipped in 2-4 international days."
...
extension RequestFinishAlert {
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            specialtyLabel.topAnchor.constraint(equalTo: fullNameLabel.bottomAnchor, constant: 27),
        ...
        bottomAnchor.constraint(equalTo: specialtyLabel.bottomAnchor, constant: 34).isActive = true
    }
}
